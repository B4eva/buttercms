...
import 'package:cms/blog_screen.dart';
import 'package:cms/cms_keys.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Future retrieveBlogPost() async {
    try {
      final url = Uri.parse(
          "${'https://api.buttercms.com'}/v2/posts?auth_token=$apiKey");
                        ...
                        (index) => BlogCard(
                            ...
                            press: () {
                              Navigator.push(context,
                                  MaterialPageRoute(builder: (contexxt) {
                                return BlogScreen(data: data[index]);
                              }));
